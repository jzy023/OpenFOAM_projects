...
output_file = "interADMFoam_layered.csv"
...
read_cols = ["Time", "SacAve", "Sh2Ave", "Sch4Ave", "Sco2Ave", "Gh2", "RGh2", "Gch4", "RGch4", "Gco2", "RGco2"]
write_cols = ["Time", "Sac", "Sh2", "Sch4", "Sco2", "Gh2", "RGh2", "Gch4", "RGch4", "Gco2", "RGco2"]
